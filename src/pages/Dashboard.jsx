...
export default function Dashboard(){
 ...
 if(role==='employee') return <section>
   ...
   <div className="action-grid"><Action to="/branches" title="View Branches" text="Browse branch information and connectivity details." icon="⌂"/><Action to="/accomplishment" title="Add Accomplishment" text="Record a new branch visit and print the A4 form." icon="＋"/><Action to="/accomplishment" title="Accomplishment" text="Review, view and print your previous records." icon="↻"/></div>
 </section>;

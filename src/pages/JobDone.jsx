...
export default function JobDone(){
  ...
  return <>
    ...
    {viewing&&<div className="modal-backdrop" role="presentation" onMouseDown={e=>{if(e.target===e.currentTarget)closeModals()}}><div className="modal branch-modal view-job-done-modal" role="dialog" aria-modal="true">
